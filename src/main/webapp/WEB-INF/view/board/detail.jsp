...
<body>
    ...
    <%if (prevIboard != 0) { %>
        <span><a href="/board/detail?iboard=<%=prevIboard%>"><input type="button" value="이전글"></a></span>
    <% } %>

    <%if (nextIboard != 0) { %>
        <span><a href="/board/detail?iboard=<%=nextIboard%>"><input type="button" value="다음글"></a></span>
    <% } %>
